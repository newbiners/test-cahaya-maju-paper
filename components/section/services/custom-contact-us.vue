            ...
            >
                ...
                <div class="flex w-full lg:flex-1 section-right">
                    <div class="flex flex-col gap-12 w-100% mt-8">
                        <h1 class="my-0 text-white">Get Started Today – Let’s Build Your Custom Website!
                        </h1>
                        <p class="text-white w-full lg:w-3/4">Your business deserves a fast, secure, and scalable website designed for success.
